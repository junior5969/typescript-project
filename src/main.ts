...
let processo1 = new ProcessoProduzione(
  "riciclo acqua",
  "implementare tecnologie per un minore utilizzo idrico e il recupero delle acque reflue",
  []
);

let processo2 = new ProcessoProduzione(
  "gestione degli scarti",
  "riduzione degli scarti di produzione, riciclo dei rifiuti tessili e adozione di pratiche di upcycling per trasformare i capi dismessi in nuovi prodotti",
  []
);
